...
\minipage{0.45\textwidth}
	\begin{tabular}{l c}
		${\sf Forg}_{\Pi, \mathbb{B}}(\mathcal{A}^\mathcal{O})$\\
			...
			${\mathbf{\tilde{z}}} \gets \mathcal{A}^{ \mathcal{O}_{\mathcal{B}}} ( \mathbf{c_x}, {\sf csk} )$ \\	
...
\minipage{0.45\textwidth}
	\begin{tabular}{l c}
		${\sf Forg'}_{\Pi, \mathbb{B}}(\mathcal{A'}^{\mathcal{O}})$\\
			...
			${\mathbf{\tilde{z}}} \gets \mathcal{A'}^{\mathcal{O}_{\sf samp}}()$ \\
...
\minipage{0.45\textwidth}
	\begin{tabular}{l c}
		${\sf Reuse}_{\Pi, \mathbb{B}}(\mathcal{A}^\mathcal{O})$\\
			...
			${\mathbf{\tilde{z}}} \gets \mathcal{A}^{\mathcal{O}_{\sf Enroll}^{\sf Re}, \mathcal{O}_{\sf Probe}^{\sf Re}} ( \mathbf{c_x}, {\sf csk} )$ \\
