...
For a biometric distribution $\mathcal{B} \in \mathbb{B}$ and $\mathbf{x} \gets \textsf{encodeEnroll}^{\mathcal{O}_\mathcal{B}}()$, define the \emph{true positive rates} \textsf{TP}.
\begin{align*}
