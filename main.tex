...
Since $\{ \mathcal{O}^\prime_{\textsf{KeyGen}}, \gamma \}$-RUF security implies $\{ \emptyset, \gamma \}$-RUF security, with Theorem \ref{thm:fh-IPFE:ind-OKeyGen-gamma-ruf}, we have the following corollary.
