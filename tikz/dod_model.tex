...
\node (station) [element] at (7,8) {\sf Station};

\node (device1) [element] at (7,5.5) {\sf Device};

\node (device2) [element] at (7,3.5) {\sf Device};

\node (device3) [element] at (7,1.5) {\sf Device};

\begin{pgfonlayer}{background layer}
    \draw [rounded corners, fill=blue!50!white] ($(device1) + (-1.1, 1.4)$) rectangle ($(device2) + (1.1, -0.75)$);
\end{pgfonlayer}
...
\node (domain1) [
    ...
    fill=blue!50!white,
    draw=black]
at ($(device1)!0.5!(device2) + (0, 0.5)$) {};
\end{pgfonlayer};

\node (domain1_text) [element,fill=none,draw=none] at ($(domain1.north) + (0, -0.5)$) {\sf Domain 1};
...
% \begin{pgfonlayer}{background layer}
% \draw [rounded corners, fill=orange!50!white] ($(device3) + (-1.1, 0.75)$) rectangle ($(device3) + (1.1, -0.75)$);
% \end{pgfonlayer}
